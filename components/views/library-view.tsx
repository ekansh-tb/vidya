  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-0 inset-x-0 z-[81] max-w-2xl mx-auto rounded-t-3xl glass-strong p-6 pb-8"
      >
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <div className={`font-display text-2xl font-bold text-white leading-tight ${isDeva ? "font-deva" : ""}`}>
              {book.title}
            </div>
